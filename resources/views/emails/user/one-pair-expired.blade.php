...
# One of your Donors failed to donate in time.

Hi {{$pair->receiver->user->username}},

@component('mail::panel')
One of your donors ({{ ucwords($pair->payer->user->userDetail->firstname)  }} {{ ucwords($pair->payer->user->userdetail->lastname)  }})
failed to pay before the grace time expired.
