...
<ul class="nav-header pull-left">
    <li class="header-content">
        <a class="h5" href="{{ URL::asset('/') }}">
                                                            <img class="img-responsive hidden-xs"  src="{{ secure_asset('/assets/img/logo.png') }}"
                             alt="logo">
                                          <img class="img-responsive hidden-lg hidden-md"  src="{{ secure_asset('/assets/img/logosmall.png') }}"
                             alt="logo">  
        </a>
    </li>
</ul>
