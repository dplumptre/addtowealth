        ...
        <div class="content">
            ...
            <div class="alert alert-info alert-dismissable">
                ...
                <p><i class="fa fa-info-circle"></i>
                    <strong>
                        You should only select a package when you have enough funds to spare. Your funds will eventually be allocated to a Recipient, but you must exercise patience
                    </strong>
                </p>
            </div>
            ...
            <div class="block block-bordered">
                <div class="block block-themed">
                    ...
                    <div class="block-content">
                        ...
                        <form class="form-horizontal push-10-t push-10" action="{{  secure_url('user-area/donate') }}"
                              method="post">
                            {{csrf_field()}}
                            <div class="row">
                                <div class="col-sm-7">
                            ...
                            <div class="form-group">
                                <div class="col-xs-12">
                                    <button class="btn btn-warning"
                                            onclick="return confirm('Are you sure you are ready and have the funds to donate ?');"
                                            type="submit"><i class="fa fa-check push-5-r"></i> Begin
                                    </button>
                                </div>
                            </div>
                        </form>
                            ...
                            @foreach($payer as $key => $p)
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><span
                                                class="label label-warning">{{ $arr[$p->status] }} <!--Pending / completed --></span>
                                    </td>
                                    <td class="text-center">
                                        ...
                                        @else
                                            <form class="form-horizontal push-5-t"
                                                  action="{{ url('user-area/donate/'.$p->id) }}" method="POST">
                                                <input type="hidden" name="_method" value="delete"/>
                                                {{csrf_field()}}
                                                <button type="submit"
                                                        onclick="javascript:return confirm('Are you sure to delete this record?')"
                                                        class="label label-danger"><i class="fa fa-trash-o"></i>
                                                </button>
                                            </form>
                                        @endif
